...
BUILDINGS = [[pygame.transform.scale(pygame.image.load('idleMiningEmpire/assets/elevatorLevel.png'), (elevatorLevelD[0] * scaleFactor, elevatorLevelD[1] * scaleFactor)), 60, 300],
             ...
             [pygame.transform.scale(pygame.image.load('idleMiningEmpire/assets/elevatorDock.png'), (elevatorDock[0] * scaleFactor, elevatorDock[1] * scaleFactor)), 60, STAGES[0][0] - (elevatorDock[1]-4) * scaleFactor]]